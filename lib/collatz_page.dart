...
class CollatzPage extends StatefulWidget {
  ...
  @override
  State<CollatzPage> createState() => _CollatzPageState();
}

class _CollatzPageState extends State<CollatzPage>
  ...
  List<int> _generateCollatzSequence(int n) {
    List<int> sequence = [];
    while (n != 1) {
      sequence.add(n);
      if (n % 2 == 0) {
  ...
  void _calculateCollatz() {
    ...
    final sequence = _generateCollatzSequence(input);
    setState(() {
      _sequence = sequence.join(', ');
      _result = 'The Collatz sequence for $input is:';
      _error = null;
      _showResult = true;
    });
  }
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.rotate(
                      ...
                      child: Icon(
                        Icons.alt_route, // path/route for Collatz
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.format_list_numbered, color: Colors.teal[400]),
                            filled: true,
